...
def predict_1():
    ...
    X_new_dtr = {'transportation_name': [int(values['transport_name'])], 'type of car': [int(values['kind'])], 'start point': [int(values['start'])], 'end point': [int(values['finish'])], 'visibility': [int(values['visibility'])], 'weather': [int(values['weather'])], 'distance': [int(values['distance'])], 'surge_multiplier': [int(values['surge_multiplier'])]}
...
def predict_2():
    ...
    X_new = {'transportation_name': [int(values['transport_name'])], 'type of car': [int(values['kind'])], 'start point': [int(values['start'])], 'end point': [int(values['finish'])], 'visibility': [int(values['visibility'])], 'weather': [int(values['weather'])], 'distance': [int(values['distance'])], 'surge_multiplier': [int(values['surge_multiplier'])]}
